...
export default function Nav() {
	...
	return (
		<div>
			<nav className="relative px-4 py-4 flex justify-between font-semibold items-center">
			...
			<div className="navbar-menu relative z-50 hidden">
				...
				<nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-gray-900 border-r overflow-y-auto">
					<button className="navbar-close flex justify-end">
						<svg className="h-4 w-4 text-indigo-100 cursor-pointer hover:text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
					...
					<div>
						<ul>
							<li className="mb-1">
								<a className={splitLocation[1] === "for-sale" ? "active block p-4  font-semibold hover:bg-blue-50 hover:text-blue-600 rounded" : "block p-4  font-semibold text-indigo-100 hover:bg-blue-50 hover:text-blue-600 rounded"} href="/for-sale">For Sale</a>
							</li>
							<li className="mb-1">
								<a className={splitLocation[1] === "to-rent" ? "active block p-4  font-semibold hover:bg-blue-50 hover:text-blue-600 rounded" : "block p-4  font-semibold text-indigo-100 hover:bg-blue-50 hover:text-blue-600 rounded"} href="/to-rent">To Rent</a>
							</li>
							<li className="mb-1">
								<a className={splitLocation[1] === "owned" ? "active block p-4  font-semibold hover:bg-blue-50 hover:text-blue-600 rounded" : "block p-4  font-semibold text-indigo-100 hover:bg-blue-50 hover:text-blue-600 rounded"} href="/owned">My Properties</a>
							</li>
							<li className="mb-1">
								<a className={splitLocation[1] === "renting" ? "active block p-4  font-semibold hover:bg-blue-50 hover:text-blue-600 rounded" : "block p-4  font-semibold text-indigo-100 hover:bg-blue-50 hover:text-blue-600 rounded"} href="/renting">My Renting</a>
							</li>
							<li className="mb-1">
								<a className={splitLocation[1] === "all-properties" ? "active block p-4  font-semibold hover:bg-blue-50 hover:text-blue-600 rounded" : "block p-4 text-base font-semibold text-indigo-100 hover:bg-blue-50 hover:text-blue-600 rounded"} href="/all-properties">All Properties</a>
							</li>
							<li className="mb-1">
