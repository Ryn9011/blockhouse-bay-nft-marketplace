...
const ToRent = () => {
  ...
  const loadProperties = async () => {
    ...
    const data = await marketContract.fetchPropertiesSold() //add onlyrentable. change needs to trigger load
  ...
  if (loadingState === 'loaded' && !currentPosts.length) return (
    <>
      <h1 className="px-8 lg:px-24 pt-10 text-3xl">No properties currently for rent</h1>
      <p className='text-white text-xl pt-4 pl-8 lg:pl-32'>Check back soon for new rentals</p>
    </>
  )
    ...
    <div className="pt-10 pb-10">
      <div className="flex justify-center">
        <div className="px-4" style={{ maxWidth: "1600px" }}>
          <h1 className="text-white mb-2">Available to Rent</h1>
          <div className="flex text-white pl-4">
            ...
            <div className="pb-2 pt-5 hidden lg:block">
              <img
