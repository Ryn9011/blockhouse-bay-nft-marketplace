...
const Renting = () => {
  ...
  if (loadingState === 'loaded' && !rentedProperties.length) return (
    <>
      <h1 className="px-8 lg:px-24 pt-10 text-3xl">You are not currently renting any properties</h1>
      <p className='text-white text-xl pt-4 pl-8 lg:pl-32'>Rent an owned property and check back here</p>
    </>    
  )
