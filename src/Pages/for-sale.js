                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-2 pt-2 pb-2 bg-black">
                      <div className="pb-2">
                        <div className="flex divide-x divide-white mb-2 text-2xl lg:text-base">
                          <div className="flex justify-between px-2">
                            <div className='pt-1.5'>
                              <input
                                className="rounded-full flex-shrink-0 h-3 w-3 border border-pink-400 bg-white checked:bg-pink-600 checked:border-pink-600 focus:outline-none transition duration-200 mt-2 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer"
                                type="radio"
                            ...
                            <div>
                              <img
                                className="object-none scale-75 pt-3.5 lg:pt-1.5"
                                src="./matic-icon.png"
                                alt=""
                              ></img>
                            </div>
